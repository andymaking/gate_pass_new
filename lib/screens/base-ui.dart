...
class BaseView<T extends BaseViewModel> extends StatefulWidget {
  ...
  const BaseView(
      {super.key, this.builder, this.onModelReady, this.onDisposeModel, this.useFullScreenLoader=false, this.onMount, this.loaderColor, this.didChangeAppLifecycleState});
