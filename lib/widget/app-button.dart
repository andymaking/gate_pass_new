...
class AppButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Color backgroundColor = backGroundColor ?? Theme.of(context).primaryColor;
    final Color borderClr =  borderColor ?? stateColor11(isAppDark(context));
    ...
    ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: onTap == null || isLoading? backgroundColor.withValues(alpha: 0.6) : backgroundColor,
